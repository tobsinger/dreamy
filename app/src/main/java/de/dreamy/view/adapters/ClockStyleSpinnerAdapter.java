...
/**
 */
public class ClockStyleSpinnerAdapter extends SimpleAdapter {

    private static final String KEY = "connectionType";

    public ClockStyleSpinnerAdapter(Context context) {
    ...
    private static List<Map<String, String>> getData(Resources resources) {
        ...
        for (Settings.ClockStyle type : Settings.ClockStyle.values()) {
